...
function UserCartItemsContent({ cartItem }) {
  ...
  function handleUpdateQuantity(getCartItem, typeOfAction) {
    ...
    dispatch(
      ...
      if (data?.payload?.success) {
        ...
        toast({
          title: data?.payload?.message || "Unable to update the cart item",
          variant: "destructive",
        });
      }
    });
  ...
  function handleCartItemDelete(getCartItem) {
    dispatch(
      ...
      if (data?.payload?.success) {
        trackRemoveFromCart(getCartItem, getCartItem?.quantity || 1);
        toast({
        ...
        toast({
          title:
            data?.payload?.message || "Unable to remove the item from the cart",
          variant: "destructive",
        });
      }
    });
